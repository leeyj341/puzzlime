...
public class PlayerState : MonoBehaviour
{
    ...
    private ATK_CATEGORI weaponCategory = ATK_CATEGORI.HACK;                // 현재 무기 종류
    private float atkSpeed = 1.0f;                                          // 공격속도

    // 애니메이션 관련 변수

    private ANIM_SORT curAni = ANIM_SORT.NONE;
    private float animPlaySpeed = 1.0f;                                     // 최종 애니메이션 재생속도
    private float slashSpeed = 3.0f;
    private float stabSpeed = 1.5f;
    ...
    public ATK_CATEGORI WeaponCategory { get => weaponCategory; set => weaponCategory = value; }
